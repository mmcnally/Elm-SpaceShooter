   ...
   var render = function (state) {
      return function () {
         var fixPosition = {ctor: "_Tuple2"
                           ,_0: 0 - state.ship.x
                           ,_1: 0 - state.ship.y};
         var fixAngle = 0 - state.ship.angle + Basics.pi / 2;
...
Elm.Ship.make = function (_elm) {
   ...
   var renderHealth = function (_v3) {
      return function () {
         ...
         0) ? A2(Graphics.Collage.outlined,
         Graphics.Collage.dashed(Color.red),
         A2(Graphics.Collage.rect,
         200,
         200)) : A2(Graphics.Collage.outlined,
         Graphics.Collage.dashed(Color.red),
         A2(Graphics.Collage.rect,
         200,
         200));
   ...
   var render = function (_v5) {
      return function () {
         return Graphics.Collage.move({ctor: "_Tuple2"
                                      ,_0: _v5.x
                                      ,_1: _v5.y})(Graphics.Collage.rotate(_v5.angle)(Graphics.Collage.group(_L.fromArray([Graphics.Collage.filled(_v5.color.body)(A2(Graphics.Collage.ngon,
                                                                                                                          3,
                                                                                                                          _v5.size))
                                                                                                                          ,Graphics.Collage.move({ctor: "_Tuple2"
                                                                                                                                                 ,_0: _v5.size * 0.1
                                                                                                                                                 ,_1: 0})(Graphics.Collage.filled(_v5.color.window)(A2(Graphics.Collage.ngon,
                                                                                                                          3,
                                                                                                                          _v5.size * 0.7)))
                                                                                                                          ,Graphics.Collage.filled(_v5.color.body2)(A2(Graphics.Collage.ngon,
                                                                                                                          3,
                                                                                                                          _v5.size * 0.2))]))));
      }();
   };
